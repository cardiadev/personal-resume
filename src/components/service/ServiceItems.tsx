...
import { SleekContext, type ServiceModalData } from "@/src/Context";
...
const services: ServiceModalData[] = [
  {
    ...
    name: "Web Design",
    text: [
      "Sleek delivers web design and frontend engineering focused on clarity, conversion, and a strong product experience that reflects your brand.",
  ...
  },
  {
    ...
    text: [
      "Sleek shapes content with product intent, making sure copy supports navigation, explains value clearly, and helps people move through the experience.",
      "In today's digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user's first impression relates to web design. It's also why web design services can have an immense impact on your company's bottom line.",
  ...
  },
  {
    ...
    name: "Brand Identity",
    text: [
      "Sleek helps translate product positioning into a sharper digital identity through typography, visual structure, and consistent interface decisions.",
      "In today's digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user's first impression relates to web design. It's also why web design services can have an immense impact on your company's bottom line.",
  ...
  },
  {
    ...
    name: "Live Chat",
    text: [
      "Sleek integrates real-time support experiences that feel native to the product instead of bolted on as an afterthought.",
      "In today's digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user's first impression relates to web design. It's also why web design services can have an immense impact on your company's bottom line.",
  ...
  },
  {
    ...
    name: "After Effects",
    text: [
      "Sleek uses motion intentionally to support storytelling, highlight hierarchy, and make interactions feel more polished and alive.",
      "In today's digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user's first impression relates to web design. It's also why web design services can have an immense impact on your company's bottom line.",
  ...
  },
  {
    ...
    name: "Mobile App",
    text: [
      "Sleek designs mobile experiences that prioritize usability, speed, and clear flows so people can complete tasks without friction.",
      "In today's digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user's first impression relates to web design. It's also why web design services can have an immense impact on your company's bottom line.",
...
const ServiceItems = () => {
  const { setServiceModal, modalToggle } = useContext(SleekContext);
  return (
        ...
        {services.map((service) => (
          <li className="mb-[40px] w-1/3 pl-[40px]" key={service.id}>
            <div className="list_inner w-full h-auto clear-both float-left relative border-solid border-[rgba(0,0,0,.1)] border bg-white pt-[45px] pr-[30px] pb-[40px] pl-[30px] transition-all duration-300">
              ...
              <div className="sleek_tm_read_more">
                <a
                  href="#"
                  onClick={(e) => {
                    e.preventDefault();
