...
const Skills = () => {
  return (
    <div className="sleek_tm_progressbox w-full h-auto clear-both float-left bg-white pt-[93px] pr-[0px] pb-[100px] pl-[0px]">
      <div className="container">
        <div className="in w-full h-auto clear-both float-left flex">
          ...
          <div className="right w-1/2 pl-[50px]">
            ...
            <div className="sleek_section_title w-full h-auto clear-both float-left mt-[45px]">
